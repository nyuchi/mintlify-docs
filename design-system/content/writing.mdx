...
**Shona and Ndebele are primary languages** in the Mukoko ecosystem, alongside English. Content should be written with translation into these languages in mind from the start. **Lingo**, a dedicated mukoko mini-app for African language learning, exists as a product — a reminder that language in this ecosystem is not an afterthought but a first-class concern.
