...
The resource detail pattern is used for pages that display a single item in depth — an event page, a news article, a weather location, or a user profile. It complements the [Resource Index](/design-system/patterns/resource-index) pattern.
