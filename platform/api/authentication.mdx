...
<Steps>
  <Step title="Send the user to /v1/auth/workos/login">
  ...
  <Step title="WorkOS posts back to the backend">
  ...
  <Step title="The backend redirects the browser with the token in the fragment">
  ...
  <Step title="Your client consumes the fragment">
